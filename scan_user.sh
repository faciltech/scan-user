...
read -p $'\e[1;92m[\e[0m\e[1;77m?\e[0m\e[1;92m] Entre com o nome do usuario ou deixe em branco:\e[0m ' username
...
S|s|Sim|SIM|sim)
		...
		echo -e "\e[1;92m[✔] Dados enviados para o telegram com sucesso.\e[0m"
      else
